...
hl.common = {
  ...
  TermCursorNC = { fg = c.base, bg = "#7c7f93" },
  StatusLine = { fg = c.fg, bg = c.bg },
  MiniStatuslineModeCommand = { fg = "#e0e0e0", bg = c.comment },
  MiniStatuslineModeInsert = { fg = "#e0e0e0", bg = c.comment },
  MiniStatuslineModeNormal = { fg = "#e0e0e0", bg = c.comment },
  MiniStatuslineModeOther = { fg = "#e0e0e0", bg = c.comment },
  MiniStatuslineModeReplace = { fg = "#e0e0e0", bg = c.comment },
  MiniStatuslineModeVisual = { fg = "#e0e0e0", bg = c.comment },
