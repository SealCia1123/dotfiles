...
hl.common = {
  ...
  MiniStatuslineModeCommand = { fg = c.fg, bg = "#1c1f20" },
  MiniStatuslineModeInsert = { fg = c.fg, bg = "#1c1f20" },
  MiniStatuslineModeNormal = { fg = c.fg, bg = "#1c1f20" },
  MiniStatuslineModeOther = { fg = c.fg, bg = "#1c1f20" },
  MiniStatuslineModeReplace = { fg = c.fg, bg = "#1c1f20" },
  MiniStatuslineModeVisual = { fg = c.fg, bg = "#1c1f20" },
